...
### **Day_054_HW** － clustering 1 非監督式機器學習簡介：
...
### **Day_057_HW** － clustering 3 階層分群算法：
...
### **Day_058_HW** － 階層分群法 觀察 : 使用 2D 樣版資料集：
...
### **Day_059_HW** － dimension reduction 1 降維方法-主成份分析：
...
### **Day_061_HW** － dimension reduction 2 降維方法-T-SNE：
...
> ### 認識了基本分群方法與降維方法-主成份分析的應用，了解到非監督與監督式學習的差別
...
> ### 認識神經網路基本原理以及透過Tensorflow Playground體驗深度學習，對於深度學習已有了基本認知！

## 主題七：初探深度學習使用Keras

### **Day_066_HW** － Keras 安裝與介紹：
...
### **Day_068_HW** － Keras Sequential API：
...
### **Day_070_HW** － Multi-layer Perception多層感知：
...
### **Day_073_HW** － 梯度下降Gradient Descent：
...
### **Day_074_HW** － Gradient Descent 數學原理：
...
### **Day_077_HW** － 訓練神經網路的細節與技巧 - Validation and overfit：
...
### **Day_079_HW** － 訓練神經網路的細節與技巧 - Learning rate effect：
...
### **Day_080_HW** － [練習 Day] 優化器與學習率的組合與比較：
...
### **Day_081_HW** － 訓練神經網路的細節與技巧 - Regularization：
...
### **Day_082_HW** － 訓練神經網路的細節與技巧 - Dropout：
...
### **Day_083_HW** － 訓練神經網路的細節與技巧 - Batch normalization：
...
### **Day_084_HW** － [練習 Day] 正規化/機移除/批次標準化的 組合與比較：
...
### **Day_085_HW** － 訓練神經網路的細節與技巧 - 使用 callbacks 函數做 earlystop：
...
### **Day_086_HW** － 訓練神經網路的細節與技巧 - 使用 callbacks 函數儲存 model：
...
### **Day_087_HW** － 訓練神經網路的細節與技巧 - 使用 callbacks 函數做 reduce learning rate：
...
### **Day_088_HW** － 訓練神經網路的細節與技巧 - 撰寫自己的 callbacks 函數：
...
### **Day_089_HW** － 訓練神經網路的細節與技巧 - 撰寫自己的 Loss function：
...
### **Day_090_HW** － 使用傳統電腦視覺與機器學習進行影像辨識：
...
### **Day_091_HW** － [練習 Day] 使用傳統電腦視覺與機器學習進行影像辨識：
...
> ### 從認識Keras、優化器、損失函數、激活函數等，到練習非常多訓練神經網路的細節與技巧，本章對於每個環節介紹都很詳細，帶領我們一步步認識和實作！

## 主題八：深度學習應用卷積神經網路

### **Day_092_HW** － 卷積神經網路 (Convolution Neural Network, CNN) 簡介：
...
### **Day_094_HW** － 卷積神經網路 - 卷積(Convolution)層與參數調整：
...
### **Day_095_HW** － 卷積神經網路 - 池化(Pooling)層與參數調整：
...
### **Day_096_HW** － Keras 中的 CNN layers：
...
### **Day_097_HW** － 使用 CNN 完成 CIFAR-10 資料集：
...
### **Day_098_HW** － 訓練卷積神經網路的細節與技巧 - 處理大量數據：
...
### **Day_099_HW** － 訓練卷積神經網路的細節與技巧 - 處理小量數據：
...
### **Day_100_HW** － 訓練卷積神經網路的細節與技巧 - 轉移學習 (Transfer learning)：
...
> ### 認識到卷積神經網路的原理與概念，以及如何用於影像辨識的各種應用！
